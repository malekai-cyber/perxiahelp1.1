...
router.post('/chat', async (req, res) => {
    try {
        ...
        if (useRAG && lastUserMessage) {
            console.log(`[Perxia Copilot] Searching documents for: "${lastUserMessage.content.substring(0, 50)}..."`);
        ...
        console.log(`[Perxia Copilot] Response received. Tokens: ${result.tokens.total}, RAG docs: ${ragResults.length}`);
